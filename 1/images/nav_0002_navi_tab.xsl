...
<xsl:template match="params">
	...
	<xsl:variable name="tab-border-color-fixed">
		<xsl:call-template name="fix-color">
			<xsl:with-param name="color" select="tab_bordercolor"/>
		</xsl:call-template>
	</xsl:variable>
	<xsl:variable name="tab-border-color-over-fixed">
		<xsl:call-template name="fix-color">
			<xsl:with-param name="color" select="tab_bordercolor_over"/>
		</xsl:call-template>
	</xsl:variable>
	<xsl:variable name="tab-font-color-fixed">
		<xsl:call-template name="fix-color">
			<xsl:with-param name="color" select="tab_fontcolor"/>
		</xsl:call-template>
	</xsl:variable>
	<xsl:variable name="tab-font-color-over-fixed">
		<xsl:call-template name="fix-color">
			<xsl:with-param name="color" select="tab_fontcolor_over"/>
		</xsl:call-template>
	</xsl:variable>
	<xsl:variable name="tab-bg-color-fixed">
		<xsl:call-template name="fix-color">
			<xsl:with-param name="color" select="tab_bgcolor"/>
		</xsl:call-template>
	</xsl:variable>
	<xsl:variable name="tab-bg-color-over-fixed">
		<xsl:call-template name="fix-color">
			<xsl:with-param name="color" select="tab_bgcolor_over"/>
		</xsl:call-template>
	</xsl:variable>
	<xsl:variable name="tab-gradient-color-fixed">
		<xsl:call-template name="fix-color">
			<xsl:with-param name="color" select="tab_gradientcolor"/>
		</xsl:call-template>
	</xsl:variable>
	<xsl:variable name="tab-gradient-color-over-fixed">
		<xsl:call-template name="fix-color">
			<xsl:with-param name="color" select="tab_gradientcolor_over"/>
		</xsl:call-template>
	</xsl:variable>
	...
	<xsl:variable name="tab_container_width">
		<xsl:choose>
			<xsl:when test="tab_position='right' or tab_position='left'"><xsl:value-of select="tab_size_h"/></xsl:when>
			<xsl:otherwise><xsl:value-of select="$width"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_container_height">
		<xsl:choose>
			<xsl:when test="tab_position='right' or tab_position='left'"><xsl:value-of select="$height"/></xsl:when>
			<xsl:otherwise><xsl:value-of select="tab_size_h"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="panel_width">
		<xsl:choose>
			<xsl:when test="tab_position='top' or tab_position='bottom'"><xsl:value-of select="$width"/></xsl:when>
			<xsl:otherwise><xsl:value-of select="number($width)-number(tab_size_h)"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="panel_height">
		<xsl:choose>
			<xsl:when test="tab_position='left' or tab_position='right'"><xsl:value-of select="$height"/></xsl:when>
			<xsl:otherwise><xsl:value-of select="number($height)-number(tab_size_h)"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="panel_radius_string">
		<xsl:if test="number(panel_radius)!=0">
			<xsl:choose>
				<xsl:when test="tab_position='right'">0 <xsl:value-of select="panel_radius"/>px <xsl:value-of select="panel_radius"/>px 0</xsl:when>
				<xsl:when test="tab_position='left'"><xsl:value-of select="panel_radius"/>px 0 0 <xsl:value-of select="panel_radius"/>px</xsl:when>
				<xsl:when test="tab_position='top'"><xsl:value-of select="panel_radius"/>px <xsl:value-of select="panel_radius"/>px 0 0</xsl:when>
				<xsl:when test="tab_position='bottom'">0 0 <xsl:value-of select="panel_radius"/>px <xsl:value-of select="panel_radius"/>px</xsl:when>
	...
	<xsl:variable name="tab_brd_width"><xsl:value-of select="tab_borderwidth"/></xsl:variable>
	<xsl:variable name="tab_width_inner"><xsl:value-of select="number(tab_size_w)-2*number($tab_brd_width)"/></xsl:variable>
	<xsl:variable name="tab_height_inner"><xsl:value-of select="number(tab_size_h)-number($tab_brd_width)"/></xsl:variable>
	<xsl:variable name="tab_brd_color">
		<xsl:choose>
			<xsl:when test="inherit_color='yes'"><xsl:value-of select="$panel_color_brd"/></xsl:when>
			<xsl:otherwise><xsl:value-of select="$tab-border-color-fixed"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_brd_css">
		<xsl:choose>
			<xsl:when test="tab_position='right' or tab_position='left' or tab_position='bottom'">border-width: 0 <xsl:value-of select="$tab_brd_width"/>px <xsl:value-of select="$tab_brd_width"/>px <xsl:value-of select="$tab_brd_width"/>px; border-color: <xsl:value-of select="$tab_brd_color"/>; border-style: solid;</xsl:when>
			<xsl:when test="tab_position='top'">border-width: <xsl:value-of select="$tab_brd_width"/>px <xsl:value-of select="$tab_brd_width"/>px 0 <xsl:value-of select="$tab_brd_width"/>px; border-color: <xsl:value-of select="$tab_brd_color"/>; border-style: solid;</xsl:when>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_brd_radius"><xsl:value-of select="tab_radius"/></xsl:variable>
	<xsl:variable name="tab_brd_radius_css">
		<xsl:if test="number($tab_brd_radius)!=0">
			<xsl:choose>
				<xsl:when test="tab_position='right' or tab_position='left' or tab_position='bottom'">border-radius: 0 0 <xsl:value-of select="$tab_brd_radius"/>px <xsl:value-of select="$tab_brd_radius"/>px;</xsl:when>
				<xsl:when test="tab_position='top'">border-radius: <xsl:value-of select="$tab_brd_radius"/>px <xsl:value-of select="$tab_brd_radius"/>px 0 0;</xsl:when>
			</xsl:choose>
		</xsl:if>
	</xsl:variable>
	<xsl:variable name="tab_bg_color_H">
		<xsl:call-template name="hue">
			<xsl:with-param name="hexcolor" select="$panel_color_brd"/>
		</xsl:call-template>
	</xsl:variable>
	<xsl:variable name="tab_bg_color_S">
		<xsl:call-template name="saturation">
			<xsl:with-param name="hexcolor" select="$panel_color_brd"/>
		</xsl:call-template>
	</xsl:variable>
	<xsl:variable name="tab_bg_color_B">
		<xsl:call-template name="brightness">
			<xsl:with-param name="hexcolor" select="$panel_color_brd"/>
		</xsl:call-template>
	</xsl:variable>
	<xsl:variable name="tab_bg_color_H1" select="$tab_bg_color_H"/>
	<xsl:variable name="tab_bg_color_S1">
		<xsl:choose>
			<xsl:when test="round(0.3*number($tab_bg_color_S)) &gt; 100">100</xsl:when>
			<xsl:otherwise><xsl:value-of select="round(0.3*number($tab_bg_color_S))"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_bg_color_B1">
		<xsl:choose>
			<xsl:when test="round(1.8*number($tab_bg_color_B)) &gt; 100">100</xsl:when>
			<xsl:otherwise><xsl:value-of select="round(1.8*number($tab_bg_color_B))"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_bg_color">
		<xsl:choose>
			<xsl:when test="inherit_color='yes'">
				<xsl:call-template name="HSBtoHex">
					<xsl:with-param name="H" select="number($tab_bg_color_H1)"/>
					<xsl:with-param name="S" select="number($tab_bg_color_S1)"/>
					<xsl:with-param name="B" select="number($tab_bg_color_B1)"/>
				</xsl:call-template>
			</xsl:when>
			<xsl:otherwise><xsl:value-of select="$tab-bg-color-fixed"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_bg_color_H2" select="$tab_bg_color_H"/>
	<xsl:variable name="tab_bg_color_S2">
		<xsl:choose>
			<xsl:when test="round(0.2*number($tab_bg_color_S)) &gt; 100">100</xsl:when>
			<xsl:otherwise><xsl:value-of select="round(0.2*number($tab_bg_color_S))"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_bg_color_B2">
		<xsl:choose>
			<xsl:when test="round(2*number($tab_bg_color_B)) &gt; 100">100</xsl:when>
			<xsl:otherwise><xsl:value-of select="round(2*number($tab_bg_color_B))"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>	<xsl:variable name="tab_bg_color_over">
		<xsl:choose>
			<xsl:when test="inherit_color='yes'">
				<xsl:call-template name="HSBtoHex">
					<xsl:with-param name="H" select="number($tab_bg_color_H2)"/>
					<xsl:with-param name="S" select="number($tab_bg_color_S2)"/>
					<xsl:with-param name="B" select="number($tab_bg_color_B2)"/>
				</xsl:call-template>
			</xsl:when>
			<xsl:otherwise><xsl:value-of select="$tab-bg-color-fixed"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_bgimg_position_css">
		<xsl:if test="tab_bg_type='image'">
			<xsl:choose>
				<xsl:when test="tab_bgimg_position='lt'">background-position: left top;</xsl:when>
				<xsl:when test="tab_bgimg_position='lm'">background-position: left center;</xsl:when>
				<xsl:when test="tab_bgimg_position='lb'">background-position: left bottom;</xsl:when>
				<xsl:when test="tab_bgimg_position='ct'">background-position: center top;</xsl:when>
				<xsl:when test="tab_bgimg_position='cm'">background-position: center center;</xsl:when>
				<xsl:when test="tab_bgimg_position='cb'">background-position: center bottom;</xsl:when>
				<xsl:when test="tab_bgimg_position='rt'">background-position: right top;</xsl:when>
				<xsl:when test="tab_bgimg_position='rm'">background-position: right center;</xsl:when>
				<xsl:when test="tab_bgimg_position='rb'">background-position: right bottom;</xsl:when>
				<xsl:when test="tab_bgimg_position='custom'">background-position: <xsl:value-of select="tab_bgimg_position_custom"/>;</xsl:when>
				<xsl:otherwise>background-position: center center;</xsl:otherwise>
			</xsl:choose>
		</xsl:if>
	</xsl:variable>
	<xsl:variable name="tab_txt_color">
		<xsl:choose>
			<xsl:when test="inherit_color='yes'"><xsl:value-of select="$panel_color_brd"/></xsl:when>
			<xsl:otherwise><xsl:value-of select="$tab-font-color-fixed"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="rotation_transform_css">
		<xsl:choose>
			<xsl:when test="tab_position='right'">-webkit-transform:rotate(270deg); transform:rotate(270deg);</xsl:when>
			<xsl:when test="tab_position='left'">-webkit-transform:rotate(90deg); transform:rotate(90deg);</xsl:when>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="rotation_origin_css">
		<xsl:choose>
			<xsl:when test="tab_position='right'">-webkit-transform-origin: right top; -moz-transform-origin: right top; -o-transform-origin: right top; -ms-transform-origin: right top; transform-origin: right top;</xsl:when>
			<xsl:when test="tab_position='left'">-webkit-transform-origin: left top; -moz-transform-origin: left top; -o-transform-origin: left top; -ms-transform-origin: left top; transform-origin: left top;</xsl:when>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_margin_css">
		<xsl:choose>
			<xsl:when test="tab_type='custom'">
				<xsl:choose>
					<xsl:when test="tab_position='right'">margin: <xsl:value-of select="tab_offset"/>px 0 0 -<xsl:value-of select="tab_size_w"/>px;</xsl:when>
					<xsl:when test="tab_position='left'">margin: <xsl:value-of select="tab_offset"/>px 0 0 <xsl:value-of select="tab_size_h"/>px;</xsl:when>
					<xsl:when test="tab_position='top'">margin: 0 0 0 <xsl:value-of select="tab_offset"/>px</xsl:when>
					<xsl:when test="tab_position='bottom'">margin: 0 0 0 <xsl:value-of select="tab_offset"/>px;</xsl:when>
				</xsl:choose>
			</xsl:when>
			<xsl:otherwise>
				<xsl:choose>
					<xsl:when test="tab_position='right'">margin: <xsl:value-of select="tab_offset"/>px 0 0 0;</xsl:when>
					<xsl:when test="tab_position='left'">margin: <xsl:value-of select="tab_offset"/>px 0 0 0;</xsl:when>
					<xsl:when test="tab_position='top'">margin: 0 0 0 <xsl:value-of select="tab_offset"/>px</xsl:when>
					<xsl:when test="tab_position='bottom'">margin: 0 0 0 <xsl:value-of select="tab_offset"/>px;</xsl:when>
				</xsl:choose>
			</xsl:otherwise>
	...
	<xsl:variable name="_tab_font">
		<xsl:choose>
			<xsl:when test="tab_font!='custom'"><xsl:call-template name="font_selector"><xsl:with-param name="sFontID" select="tab_font"/></xsl:call-template></xsl:when>
			<xsl:otherwise><xsl:value-of select="tab_font_custom"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_font_family">font-family: <xsl:value-of select="$_tab_font"/>;</xsl:variable>
	<xsl:variable name="tab_font_weight">
		<xsl:choose>
			<xsl:when test="tab_font_style='bold'">font-weight: bold;</xsl:when>
			<xsl:when test="tab_font_style='bolditalic'">font-weight: bold;</xsl:when>
			<xsl:otherwise>font-weight: normal;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_font_style">
		<xsl:choose>
			<xsl:when test="tab_font_style='italic'">font-style: italic;</xsl:when>
			<xsl:when test="tab_font_style='bolditalic'">font-style: italic;</xsl:when>
			<xsl:otherwise>font-style: normal;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_font_transform_css">
		<xsl:choose>
			<xsl:when test="tab_text_transform!='none' and tab_text_transform!='small-caps'">text-transform: <xsl:value-of select="tab_text_transform"/>;</xsl:when>
			<xsl:when test="tab_text_transform='small-caps'">font-variant: small-caps;</xsl:when>
			<xsl:otherwise></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="tab_text_rotation_css">
		<xsl:choose>
			<xsl:when test="tab_text_direction='ltr180'">-webkit-transform:rotate(180deg); -ms-transform:rotate(180deg); -moz-transform:rotate(180deg); -o-transform:rotate(180deg); transform:rotate(180deg); -webkit-transform-origin: center center; -moz-transform-origin: center center; -o-transform-origin: center center; -ms-transform-origin: center center; transform-origin: center center;</xsl:when>
			<xsl:when test="tab_text_direction='rtl'">direction: rtl; unicode-bidi: bidi-override;</xsl:when>
			<xsl:when test="tab_text_direction='rtl180'">direction: rtl; unicode-bidi: bidi-override; -webkit-transform:rotate(180deg); -ms-transform:rotate(180deg); -moz-transform:rotate(180deg); -o-transform:rotate(180deg); transform:rotate(180deg); -webkit-transform-origin: center center; -moz-transform-origin: center center; -o-transform-origin: center center; -ms-transform-origin: center center; transform-origin: center center;</xsl:when>
			<xsl:otherwise></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>

	<xsl:variable name="tab_font_css">font-size: <xsl:value-of select="tab_font_size"/>px; <xsl:value-of select="$tab_font_family"/> <xsl:value-of select="$tab_font_weight"/> <xsl:value-of select="$tab_font_style"/> <xsl:value-of select="$tab_font_transform_css"/> <xsl:value-of select="$tab_text_rotation_css"/></xsl:variable>
	<xsl:variable name="tab_txt_color_down">
		<xsl:call-template name="lighten">
			<xsl:with-param name="color.base" select="$tab_txt_color"/>
			<xsl:with-param name="ratio" select="0.8"/>
		</xsl:call-template>
	</xsl:variable>

	<xsl:variable name="_css_body_position">
		<xsl:choose>
			<xsl:when test="tab_position='right'">left: 0; top: 0;</xsl:when>
			<xsl:when test="tab_position='left'">right: 0; top: 0;</xsl:when>
			<xsl:when test="tab_position='bottom'">left: 0; top: 0; </xsl:when>
			<xsl:otherwise>left: 0; bottom: 0;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="_css_tab_container_position">
		<xsl:choose>
			<xsl:when test="tab_position='right'">right: 0; top: 0;</xsl:when>
			<xsl:when test="tab_position='left'">left: 0; top: 0;</xsl:when>
			<xsl:when test="tab_position='bottom'">left: 0; bottom: 0;</xsl:when>
			<xsl:otherwise>left: 0; top: 0;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="_css_tab_container_sizes">width: <xsl:value-of select="$tab_container_width"/>px; height: <xsl:value-of select="$tab_container_height"/>px; min-width: <xsl:value-of select="$tab_container_width"/>px; min-height: <xsl:value-of select="$tab_container_height"/>px; max-width: <xsl:value-of select="$tab_container_width"/>px; max-height: <xsl:value-of select="$tab_container_height"/>px;</xsl:variable>
	<xsl:variable name="_css_tab_position">
		<xsl:choose>
			<xsl:when test="tab_position='right'">right: 0; top: <xsl:value-of select="tab_offset"/>px;</xsl:when>
			<xsl:when test="tab_position='left'">left: 0; top: <xsl:value-of select="tab_offset"/>px;</xsl:when>
			<xsl:when test="tab_position='top'">left: <xsl:value-of select="tab_offset"/>px; top: 0;</xsl:when>
			<xsl:when test="tab_position='bottom'">left: <xsl:value-of select="tab_offset"/>px; bottom: 0;</xsl:when>
			<xsl:otherwise>left: 0; top: 0;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="_css_tab_sizes">
		<xsl:choose>
			<xsl:when test="tab_position='right' or tab_position='left'">width: <xsl:value-of select="tab_size_h"/>px; height: <xsl:value-of select="tab_size_w"/>px; min-width: <xsl:value-of select="tab_size_h"/>px; min-height: <xsl:value-of select="tab_size_w"/>px; max-width: <xsl:value-of select="tab_size_h"/>px; max-height: <xsl:value-of select="tab_size_w"/>px;</xsl:when>
			<xsl:when test="tab_position='top' or tab_position='bottom'">width: <xsl:value-of select="tab_size_w"/>px; height: <xsl:value-of select="tab_size_h"/>px; min-width: <xsl:value-of select="tab_size_w"/>px; min-height: <xsl:value-of select="tab_size_h"/>px; max-width: <xsl:value-of select="tab_size_w"/>px; max-height: <xsl:value-of select="tab_size_h"/>px;</xsl:when>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="_tab_html_width">
		<xsl:choose>
			<xsl:when test="tab_position='right' or tab_position='left'"><xsl:value-of select="number(tab_size_h)-number(tab_borderwidth)"/></xsl:when>
			<xsl:when test="tab_position='top' or tab_position='bottom'"><xsl:value-of select="number(tab_size_w)-2*number(tab_borderwidth)"/></xsl:when>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="_tab_html_height">
		<xsl:choose>
			<xsl:when test="tab_position='right' or tab_position='left'"><xsl:value-of select="number(tab_size_w)-2*number(tab_borderwidth)"/></xsl:when>
			<xsl:when test="tab_position='top' or tab_position='bottom'"><xsl:value-of select="number(tab_size_h)-number(tab_borderwidth)"/></xsl:when>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="_tab_html_border_radius">
		<xsl:choose>
			<xsl:when test="tab_position='right'">0 <xsl:value-of select="tab_radius"/>px <xsl:value-of select="tab_radius"/>px 0</xsl:when>
			<xsl:when test="tab_position='left'"><xsl:value-of select="tab_radius"/>px 0 0 <xsl:value-of select="tab_radius"/>px</xsl:when>
			<xsl:when test="tab_position='top'"><xsl:value-of select="tab_radius"/>px <xsl:value-of select="tab_radius"/>px 0 0</xsl:when>
			<xsl:when test="tab_position='bottom'">0 0 <xsl:value-of select="tab_radius"/>px <xsl:value-of select="tab_radius"/>px</xsl:when>
			<xsl:otherwise></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="_css_tab_html_border_radius">-webkit-border-radius: <xsl:value-of select="$_tab_html_border_radius"/>; border-radius: <xsl:value-of select="$_tab_html_border_radius"/>;</xsl:variable>
	<xsl:variable name="_css_tab_html_sizes">width: <xsl:value-of select="$_tab_html_width"/>px; height: <xsl:value-of select="$_tab_html_height"/>px; min-width: <xsl:value-of select="$_tab_html_width"/>px; min-height: <xsl:value-of select="$_tab_html_height"/>px; max-width: <xsl:value-of select="$_tab_html_width"/>px; max-height: <xsl:value-of select="$_tab_html_height"/>px;</xsl:variable>
	<xsl:variable name="_css_tab_html_border_width">
		<xsl:choose>
			<xsl:when test="tab_position='right'">border-width: <xsl:value-of select="tab_borderwidth"/>px <xsl:value-of select="tab_borderwidth"/>px <xsl:value-of select="tab_borderwidth"/>px 0;</xsl:when>
			<xsl:when test="tab_position='left'">border-width: <xsl:value-of select="tab_borderwidth"/>px 0 <xsl:value-of select="tab_borderwidth"/>px <xsl:value-of select="tab_borderwidth"/>px;</xsl:when>
			<xsl:when test="tab_position='top'">border-width: <xsl:value-of select="tab_borderwidth"/>px <xsl:value-of select="tab_borderwidth"/>px 0 <xsl:value-of select="tab_borderwidth"/>px;</xsl:when>
			<xsl:when test="tab_position='bottom'">border-width: 0 <xsl:value-of select="tab_borderwidth"/>px <xsl:value-of select="tab_borderwidth"/>px <xsl:value-of select="tab_borderwidth"/>px;</xsl:when>
			<xsl:otherwise></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>

	<xsl:variable name="_css_tab_html_text_pos_size">
		<xsl:choose>
			<xsl:when test="tab_position='right'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; (number(tab_size_h) + number(tab_borderwidth))">top: <xsl:value-of select="0.5*(number(tab_size_w) - number(tab_size_h) - number(tab_borderwidth))"/>px; left: -<xsl:value-of select="0.5*(number(tab_size_w) - number(tab_size_h) - number(tab_borderwidth))"/>px; width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; min-width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; min-height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; max-width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; max-height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px;</xsl:when>
					<xsl:otherwise>top: 0; left: 0; width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; min-width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; min-height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; max-width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; max-height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px;</xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="tab_position='left'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; (number(tab_size_h) + number(tab_borderwidth))">top: <xsl:value-of select="0.5*(number(tab_size_w) - number(tab_size_h) - number(tab_borderwidth))"/>px; right: -<xsl:value-of select="0.5*(number(tab_size_w) - number(tab_size_h) - number(tab_borderwidth))"/>px; width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; min-width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; min-height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; max-width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; max-height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px;</xsl:when>
					<xsl:otherwise>top: 0; right: 0; width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; min-width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; min-height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; max-width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; max-height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px;</xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="tab_position='top'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &lt; (number(tab_size_h) + number(tab_borderwidth))">top: <xsl:value-of select="0.5*(number(tab_size_h) - number(tab_size_w) + number(tab_borderwidth))"/>px; left: -<xsl:value-of select="0.5*(number(tab_size_h) - number(tab_size_w))"/>px; width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; min-width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; min-height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; max-width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; max-height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px;</xsl:when>
					<xsl:otherwise>bottom: 0; left: 0; width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; min-width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; min-height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; max-width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; max-height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px;</xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="tab_position='bottom'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &lt; (number(tab_size_h) + number(tab_borderwidth))">top: <xsl:value-of select="0.5*(number(tab_size_h) - number(tab_size_w) + number(tab_borderwidth))"/>px; left: -<xsl:value-of select="0.5*(number(tab_size_h) - number(tab_size_w))"/>px; width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; min-width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; min-height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; max-width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; max-height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px;</xsl:when>
					<xsl:otherwise>top: 0; left: 0; width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; min-width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; min-height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; max-width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; max-height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px;</xsl:otherwise>
				</xsl:choose>
	...
	<xsl:variable name="_css_tab_html_text_transform">
		<xsl:choose>
			<xsl:when test="tab_position='right'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; (number(tab_size_h) + number(tab_borderwidth))">-webkit-transform:rotate(270deg); transform:rotate(270deg); -webkit-transform-origin: 50% 50%; transform-origin: 50% 50%;</xsl:when>
					<xsl:otherwise></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="tab_position='left'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; (number(tab_size_h) + number(tab_borderwidth))">-webkit-transform:rotate(90deg); transform:rotate(90deg); -webkit-transform-origin: 50% 50%; transform-origin: 50% 50%;</xsl:when>
					<xsl:otherwise></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="tab_position='top'">
			...
			<xsl:when test="tab_position='bottom'">
				<xsl:choose>
					<xsl:when test="number($_tab_html_height) &gt; number($_tab_html_width)">-webkit-transform:rotate(270deg); transform:rotate(270deg); -webkit-transform-origin: 50% 50%; transform-origin: 50% 50%;</xsl:when>
					<xsl:otherwise></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="_css_tab_html_table_size">
		<xsl:choose>
			<xsl:when test="tab_position='right'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; (number(tab_size_h) + number(tab_borderwidth))">width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px;</xsl:when>
					<xsl:otherwise>width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px;</xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="tab_position='left'">
				<xsl:choose>
			...
			<xsl:when test="tab_position='top'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &lt; (number(tab_size_h) + number(tab_borderwidth))">width: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px; height: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px;</xsl:when>
					<xsl:otherwise>width: <xsl:value-of select="number(tab_size_w) - 2*number(tab_borderwidth)"/>px; height: <xsl:value-of select="number(tab_size_h) - number(tab_borderwidth)"/>px;</xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="tab_position='bottom'">
				<xsl:choose>
	...
	<xsl:variable name="_css_tab_img_position">
		<xsl:choose>
			<xsl:when test="tab_position='right'">left: 0; top: 0;</xsl:when>
			<xsl:when test="tab_position='left'">right: 0; top: 0;</xsl:when>
			<xsl:when test="tab_position='top'">left: 0; bottom: 0;</xsl:when>
			<xsl:when test="tab_position='bottom'">left: 0; top: 0;</xsl:when>
			<xsl:otherwise>left: 0; top: 0;</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="_basic_font">
		<xsl:choose>
			<xsl:when test="basic_font!='custom'"><xsl:call-template name="font_selector"><xsl:with-param name="sFontID" select="basic_font"/></xsl:call-template></xsl:when>
			<xsl:otherwise><xsl:value-of select="basic_font_custom"/></xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="_css_contents_font">font-family: <xsl:value-of select="$_basic_font"/>;<xsl:if test="basic_font_style='bold' or basic_font_style='bolditalic'">font-weight: bold;</xsl:if> <xsl:if test="basic_font_style='italic' or basic_font_style='bolditalic'">font-style: italic;</xsl:if> font-size: <xsl:value-of select="basic_font_size"/>px;</xsl:variable>
	<xsl:variable name="_css_search_font" select="$_css_contents_font"/>
	...
	<xsl:variable name="_css_search_btn_font" select="$_css_contents_font"/>
	...
	<xsl:variable name="_css_search_param_font">font-family: <xsl:value-of select="$_basic_font"/>; font-size: <xsl:value-of select="number(basic_font_size)-1"/>px;</xsl:variable>
	...
	<xsl:variable name="_css_gloss_font" select="$_css_contents_font"/>
	...
	<xsl:variable name="clipY1">
		<xsl:choose>
			<xsl:when test="tab_position='bottom'">0</xsl:when>
			<xsl:when test="tab_position='top'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; number(tab_size_h)"><xsl:value-of select="number($height) - number(tab_size_h) - 2"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="number($height) - number(tab_size_w) - 2"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="tab_position='left' or tab_position='right'"><xsl:value-of select="tab_offset"/></xsl:when>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="clipX1">
		<xsl:choose>
			<xsl:when test="tab_position='top' or tab_position='bottom'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; number(tab_size_h)"><xsl:value-of select="number(tab_offset) + number(tab_size_w)"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="number(tab_offset) + number(tab_size_h)"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="tab_position='left'"><xsl:value-of select="$width"/></xsl:when>
			<xsl:when test="tab_position='right'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; number(tab_size_h)"><xsl:value-of select="number(tab_size_h) + 2"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="number(tab_size_w) + 2"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="clipY2">
		<xsl:choose>
			<xsl:when test="tab_position='top'"><xsl:value-of select="$height"/></xsl:when>
			<xsl:when test="tab_position='bottom'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; number(tab_size_h)"><xsl:value-of select="number(tab_size_h) + 2"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="number(tab_size_w) + 2"/></xsl:otherwise>
			...
			<xsl:when test="tab_position='left' or tab_position='right'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; number(tab_size_h)"><xsl:value-of select="number(tab_offset) + number(tab_size_w)"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="number(tab_offset) + number(tab_size_h)"/></xsl:otherwise>
				</xsl:choose>
	...
	<xsl:variable name="clipX2">
		<xsl:choose>
			<xsl:when test="tab_position='top' or tab_position='bottom'"><xsl:value-of select="tab_offset"/></xsl:when>
			<xsl:when test="tab_position='right'">0</xsl:when>
			<xsl:when test="tab_position='left'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; number(tab_size_h)"><xsl:value-of select="number($width) - number(tab_size_h) - 2"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="number($width) - number(tab_size_w) - 2"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="_distance">
		<xsl:choose>
			<xsl:when test="tab_position='bottom' or tab_position='top'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; number(tab_size_h)"><xsl:value-of select="number($height) - number(tab_size_h)"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="number($height) - number(tab_size_w)"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="tab_position='left' or tab_position='right'">
				<xsl:choose>
					<xsl:when test="number(tab_size_w) &gt; number(tab_size_h)"><xsl:value-of select="number($width) - number(tab_size_h)"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="number($width) - number(tab_size_w)"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
		</xsl:choose>
	</xsl:variable>
	...
	<div class="style-custom" style="display: none">
		...
		<div class="rule">
			...
			<span class="rule-static"><xsl:value-of select="$_css_body_position"/><xsl:value-of select="$_css_body_sizes"/>padding: <xsl:value-of select="panel_padding"/>px; border: <xsl:value-of select="$panel_brd_width"/>px solid <xsl:value-of select="$panel_color_brd"/>; background-color: <xsl:value-of select="$panel-bg-color-fixed"/>; <xsl:if test="panel_bg_type='image'">background-image: url(<xsl:value-of select="panel_bgimg"/>); <xsl:value-of select="$panel_bgimg_position_css"/> background-repeat: <xsl:value-of select="panel_bgimg_repeat"/>;</xsl:if></span>
			<xsl:choose>
				<xsl:when test="panel_bg_type='vertical'">
				...
				<xsl:when test="panel_bg_type='horizontal'">
					<span class="rule-dynamic">
						<xsl:attribute name="data-type">linear-gradient</xsl:attribute>
		...
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-container</xsl:attribute>
			<span class="rule-static"><xsl:value-of select="$_css_tab_container_sizes"/></span>
		</div>
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab</xsl:attribute>
			<span class="rule-static"><xsl:value-of select="$_css_tab_position"/> <xsl:value-of select="$_css_tab_sizes"/></span>
		</div>
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-html</xsl:attribute>
			<span class="rule-static">background-color: <xsl:value-of select="$tab_bg_color"/>; border-color: <xsl:value-of select="$tab_brd_color"/>; <xsl:value-of select="$_css_tab_html_border_width"/><xsl:value-of select="$_css_tab_html_sizes"/><xsl:if test="tab_bg_type='image'">background-image: url(<xsl:value-of select="tab_bg_img"/>); <xsl:value-of select="$tab_bgimg_position_css"/> background-repeat: <xsl:value-of select="tab_bgimg_repeat"/>;</xsl:if></span>
			<xsl:if test="number(tab_radius)!=0">
				<span class="rule-dynamic">
					<xsl:attribute name="data-type">border-radius</xsl:attribute>
					<xsl:attribute name="data-value"><xsl:value-of select="$_tab_html_border_radius"/></xsl:attribute>
				</span>
			</xsl:if>
			<xsl:choose>
				<xsl:when test="tab_bg_type='vertical'">
					<xsl:choose>
						<xsl:when test="tab_position='right' or tab_position='left' or tab_position='bottom'">
							<span class="rule-dynamic">
								<xsl:attribute name="data-type">linear-gradient</xsl:attribute>
								<xsl:attribute name="data-angle">180</xsl:attribute>
								<xsl:attribute name="data-colors"><xsl:value-of select="$tab_bg_color"/>|0;<xsl:value-of select="$tab-gradient-color-fixed"/>|100</xsl:attribute>
							</span>
						</xsl:when>
						<xsl:otherwise>
							<span class="rule-dynamic">
				...
				<xsl:when test="tab_bg_type='horizontal'">
					<xsl:choose>
						<xsl:when test="tab_position='right' or tab_position='left' or tab_position='bottom'">
							<span class="rule-dynamic">
								<xsl:attribute name="data-type">linear-gradient</xsl:attribute>
						...
						<xsl:otherwise>
							<span class="rule-dynamic">
								<xsl:attribute name="data-type">linear-gradient</xsl:attribute>
								<xsl:attribute name="data-angle">270</xsl:attribute>
								<xsl:attribute name="data-colors"><xsl:value-of select="$tab_bg_color"/>|0;<xsl:value-of select="$tab-gradient-color-fixed"/>|100</xsl:attribute>
							</span>
						</xsl:otherwise>
					</xsl:choose>
		...
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-html-text</xsl:attribute>
			<span class="rule-static"><xsl:value-of select="$_css_tab_html_text_pos_size"/></span>
			<xsl:choose>
				<xsl:when test="tab_position='right'">
					<xsl:if test="number(tab_size_w) &gt; (number(tab_size_h) + number(tab_borderwidth))">
						<span class="rule-dynamic">
						...
						<span class="rule-dynamic">
							...
							<xsl:attribute name="data-value">50% 50%</xsl:attribute>
						</span>
					</xsl:if>
				</xsl:when>
				<xsl:when test="tab_position='left'">
					<xsl:if test="number(tab_size_w) &gt; (number(tab_size_h) + number(tab_borderwidth))">
						<span class="rule-dynamic">
							<xsl:attribute name="data-type">transform</xsl:attribute>
							<xsl:attribute name="data-value">rotate(90deg)</xsl:attribute>
						</span>
						<span class="rule-dynamic">
							<xsl:attribute name="data-type">transform-origin</xsl:attribute>
							<xsl:attribute name="data-value">50% 50%</xsl:attribute>
				...
				<xsl:when test="tab_position='bottom'">
					<xsl:if test="number($_tab_html_height) &gt; number($_tab_html_width)">
						<span class="rule-dynamic">
							<xsl:attribute name="data-type">transform</xsl:attribute>
							<xsl:attribute name="data-value">rotate(270deg)</xsl:attribute>
						</span>
		...
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-html-text-table</xsl:attribute>
			<span class="rule-static"><xsl:value-of select="$_css_tab_html_table_size"/></span>
		</div>
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-html-text-table-td</xsl:attribute>
			<span class="rule-static">color: <xsl:value-of select="$tab_txt_color"/>; <xsl:value-of select="$_css_tab_html_table_size"/><xsl:value-of select="$tab_font_css"/></span>
		</div>
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-img</xsl:attribute>
			<span class="rule-static"><xsl:value-of select="$_css_tab_sizes"/><xsl:value-of select="$_css_tab_img_position"/></span>
		</div>
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-img img</xsl:attribute>
			<span class="rule-static"><xsl:value-of select="$_css_tab_img_position"/></span>
		</div>
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-active:hover .cl-tab-html</xsl:attribute>
			<span class="rule-static">background-color: <xsl:value-of select="$tab_bg_color_over"/> !important; <xsl:if test="tab_bg_type='image'">background-image: url(<xsl:value-of select="tab_bg_img_over"/>); <xsl:value-of select="$tab_bgimg_position_css"/> background-repeat: <xsl:value-of select="tab_bgimg_repeat"/>;</xsl:if></span>
		</div>
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-tab-down .cl-tab-html td</xsl:attribute>
			<span class="rule-static">color: <xsl:value-of select="$tab_txt_color_down"/> !important;</span>
		</div>
		<xsl:if test="contenttype='contents'">
			<div class="rule">
				<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-slide-list li</xsl:attribute>
			...
			<div class="rule">
				<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .visited .cl-item-inner</xsl:attribute>
				<span class="rule-static"><xsl:value-of select="$_css_contents_visited_bg"/></span>
			</div>
			<div class="rule">
				<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .current .cl-item-inner</xsl:attribute>
				<span class="rule-static"><xsl:value-of select="$_css_contents_current_bg"/></span>
			</div>
			<div class="rule">
				<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .unvisited .cl-item-inner</xsl:attribute>
		...
		<xsl:if test="contenttype='settings'">
			...
			<div class="rule">
				<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-sett-table .cl-sett-th</xsl:attribute>
				<span class="rule-static"><xsl:value-of select="$_css_sett_border_top"/><xsl:value-of select="$_css_sett_border_bottom"/></span>
			</div>
			<div class="rule">
				<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-sett-table .cl-sett-name, #<xsl:value-of select="$objectID"/> .cl-sett-table .cl-set-value</xsl:attribute>
	...
	<div>
		...
		<xsl:attribute name="data-clip-tab">rect(<xsl:value-of select="$clipY1"/>px,<xsl:value-of select="$clipX1"/>px,<xsl:value-of select="$clipY2"/>px,<xsl:value-of select="$clipX2"/>px)</xsl:attribute>
		<xsl:attribute name="data-distance"><xsl:value-of select="$_distance"/></xsl:attribute>
		<div>
			...
			<div>
				...
				<xsl:choose>
					...
					<xsl:when test="contenttype='contents'">
						<ul>
							<xsl:attribute name="class">cl-slide-list</xsl:attribute>
						</ul>
						<ul style="display: none;">
							<li>
								...
								<div>
									...
									<div>
										<xsl:attribute name="class">cl-item-inner</xsl:attribute>
										.
									</div>
								</div>
							</li>
					...
					<xsl:when test="contenttype='settings'">
						...
						<table>
							...
							<tr>
								...
								<td>
									<xsl:attribute name="class">cl-set-value cl-sett-score</xsl:attribute>
									50
								</td>
								<td>
									<xsl:attribute name="class">cl-set-value sett-cs</xsl:attribute>
								...
								<td>
									<xsl:attribute name="class">cl-set-value</xsl:attribute>
		...
		<xsl:choose>
			<xsl:when test="tab_type='image'">
				<div>
					<xsl:attribute name="class">cl-tab-container cl-tab-container-<xsl:value-of select="tab_position"/></xsl:attribute>
					<div>
						<xsl:attribute name="class">cl-tab unselectable idle</xsl:attribute>
						<xsl:attribute name="title">
							<xsl:choose>
								<xsl:when test="contenttype='richtext'"><xsl:value-of select="alt_enabled_richtext"/></xsl:when>
								<xsl:when test="contenttype='contents'"><xsl:value-of select="alt_enabled_contents"/></xsl:when>
								<xsl:when test="contenttype='search'"><xsl:value-of select="alt_enabled_search"/></xsl:when>
								<xsl:when test="contenttype='glossary'"><xsl:value-of select="alt_enabled_glossary"/></xsl:when>
								<xsl:when test="contenttype='documents'"><xsl:value-of select="alt_enabled_documents"/></xsl:when>
								<xsl:when test="contenttype='settings'"><xsl:value-of select="alt_enabled_settings"/></xsl:when>
								<xsl:when test="contenttype='calculator'"><xsl:value-of select="alt_enabled_calculator"/></xsl:when>
								<xsl:when test="contenttype='comment'"><xsl:value-of select="alt_enabled_comment"/></xsl:when>
							</xsl:choose>
						</xsl:attribute>
						<xsl:attribute name="data-title-enabled">
							<xsl:choose>
								<xsl:when test="contenttype='richtext'"><xsl:value-of select="alt_enabled_richtext"/></xsl:when>
								<xsl:when test="contenttype='contents'"><xsl:value-of select="alt_enabled_contents"/></xsl:when>
								<xsl:when test="contenttype='search'"><xsl:value-of select="alt_enabled_search"/></xsl:when>
						...
						<xsl:attribute name="data-title-disabled">
							<xsl:choose>
								<xsl:when test="contenttype='richtext'"><xsl:value-of select="alt_disabled_richtext"/></xsl:when>
								<xsl:when test="contenttype='contents'"><xsl:value-of select="alt_disabled_contents"/></xsl:when>
								<xsl:when test="contenttype='search'"><xsl:value-of select="alt_disabled_search"/></xsl:when>
								<xsl:when test="contenttype='glossary'"><xsl:value-of select="alt_disabled_glossary"/></xsl:when>
								<xsl:when test="contenttype='documents'"><xsl:value-of select="alt_disabled_documents"/></xsl:when>
								<xsl:when test="contenttype='settings'"><xsl:value-of select="alt_disabled_settings"/></xsl:when>
								<xsl:when test="contenttype='calculator'"><xsl:value-of select="alt_disabled_calculator"/></xsl:when>
								<xsl:when test="contenttype='comment'"><xsl:value-of select="alt_disabled_comment"/></xsl:when>
							</xsl:choose>
						</xsl:attribute>
						<div>
							<xsl:attribute name="class">cl-tab-img</xsl:attribute>
							<img>
								<xsl:attribute name="class">cl-tab-img-idle</xsl:attribute>
								<xsl:attribute name="src"><xsl:value-of select="n1_img"/></xsl:attribute>
							</img>
							<img>
								<xsl:attribute name="class">cl-tab-img-over</xsl:attribute>
								<xsl:attribute name="src"><xsl:value-of select="n2_img"/></xsl:attribute>
							</img>
							<img>
								<xsl:attribute name="class">cl-tab-img-disabled</xsl:attribute>
			...
			<xsl:otherwise>
				<div>
					...
					<div>
						...
						<div>
							<xsl:attribute name="class">cl-tab-html</xsl:attribute>
							<div>
								<xsl:attribute name="class">cl-tab-html-text</xsl:attribute>
								<table>
									<xsl:attribute name="class">cl-tab-html-text-table</xsl:attribute>
									<tbody>
										<tr>
											<td>
												<xsl:attribute name="class">cl-tab-html-text-table-td</xsl:attribute>
												<xsl:choose>
													<xsl:when test="contenttype='richtext'"><xsl:value-of select="tab_text_richtext"/></xsl:when>
													<xsl:when test="contenttype='contents'"><xsl:value-of select="tab_text_contents"/></xsl:when>
													<xsl:when test="contenttype='search'"><xsl:value-of select="tab_text_search"/></xsl:when>
													<xsl:when test="contenttype='glossary'"><xsl:value-of select="tab_text_glossary"/></xsl:when>
													<xsl:when test="contenttype='documents'"><xsl:value-of select="tab_text_documents"/></xsl:when>
													<xsl:when test="contenttype='settings'"><xsl:value-of select="tab_text_settings"/></xsl:when>
													<xsl:when test="contenttype='calculator'"><xsl:value-of select="tab_text_calculator"/></xsl:when>
													<xsl:when test="contenttype='comment'"><xsl:value-of select="tab_text_comment"/></xsl:when>
												</xsl:choose>
											</td>
										</tr>
									</tbody>
