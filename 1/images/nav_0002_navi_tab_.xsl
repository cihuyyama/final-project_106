...
<xsl:template match="params">
	...
	<xsl:variable name="panel_radius_css">
		<xsl:if test="number(panel_radius)!=0">
			<xsl:choose>
				<xsl:when test="tab_position='right'">border-radius: 0 <xsl:value-of select="panel_radius"/>px <xsl:value-of select="panel_radius"/>px 0;</xsl:when>
				<xsl:when test="tab_position='left'">border-radius: <xsl:value-of select="panel_radius"/>px 0 0 <xsl:value-of select="panel_radius"/>px;</xsl:when>
				<xsl:when test="tab_position='top'">border-radius: <xsl:value-of select="panel_radius"/>px <xsl:value-of select="panel_radius"/>px 0 0;</xsl:when>
				<xsl:when test="tab_position='bottom'">border-radius: 0 0 <xsl:value-of select="panel_radius"/>px <xsl:value-of select="panel_radius"/>px;</xsl:when>
	...
	<xsl:variable name="panel_background_css">
		...
		<xsl:choose>
			<xsl:when test="panel_bgtype='vertical'">
				background-image: linear-gradient(180deg, <xsl:value-of select="$panel_color_bg"/>, <xsl:value-of select="$panel_color_gradient"/>);
			</xsl:when>
			<xsl:when test="panel_bgtype='horizontal'">
				background-image: linear-gradient(90deg, <xsl:value-of select="$panel_color_bg"/>, <xsl:value-of select="$panel_color_gradient"/>);
			</xsl:when>
			<xsl:when test="panel_bgtype='image'">
				background-image: url('file:///<xsl:value-of select="translate(substring-before($moduleImagesFolder,'images\'),'\','/')"/><xsl:value-of select="panel_bgimg"/>');
				<xsl:value-of select="$panel_bgimg_position_css"/> background-repeat: <xsl:value-of select="panel_bgimg_repeat"/>;
			</xsl:when>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="panel_shadow_css">-webkit-box-shadow: <xsl:value-of select="$_shadow_string"/>; box-shadow: <xsl:value-of select="$_shadow_string"/>;</xsl:variable>
	...
	<xsl:variable name="tab_bg_css">
		background-color: <xsl:value-of select="$tab_bg_color"/>;
		<xsl:if test="inherit_color!='yes'">
			<xsl:choose>
				<xsl:when test="tab_bg_type='vertical'">
					<xsl:choose>
						<xsl:when test="tab_position='right' or tab_position='left' or tab_position='bottom'">
							background-image: linear-gradient(180deg, <xsl:value-of select="$tab_bg_color"/>, <xsl:value-of select="$tab-gradient-color-fixed"/>);
						</xsl:when>
						<xsl:otherwise>
							background-image: linear-gradient(0deg, <xsl:value-of select="$tab_bg_color"/>, <xsl:value-of select="$tab-gradient-color-fixed"/>);
						</xsl:otherwise>
					</xsl:choose>
				</xsl:when>
				<xsl:when test="tab_bg_type='horizontal'">
					<xsl:choose>
						<xsl:when test="tab_position='right' or tab_position='left' or tab_position='bottom'">
							background-image: linear-gradient(90deg, <xsl:value-of select="$tab_bg_color"/>, <xsl:value-of select="$tab-gradient-color-fixed"/>);
						</xsl:when>
						<xsl:otherwise>
							background-image: linear-gradient(270deg, <xsl:value-of select="$tab_bg_color"/>, <xsl:value-of select="$tab-gradient-color-fixed"/>);
						</xsl:otherwise>
					</xsl:choose>
				</xsl:when>
				<xsl:when test="tab_bg_type='image'">
					background-image: url('file:///<xsl:value-of select="translate(substring-before($moduleImagesFolder,'images\'),'\','/')"/><xsl:value-of select="tab_bg_img"/>');
					<xsl:value-of select="$tab_bgimg_position_css"/> background-repeat: <xsl:value-of select="tab_bgimg_repeat"/>;
				</xsl:when>
			</xsl:choose>
		</xsl:if>
	</xsl:variable>
	...
	<xsl:variable name="_css_tab_html_border_radius">border-radius: <xsl:value-of select="$_tab_html_border_radius"/>;</xsl:variable>
	...
	<xsl:variable name="_css_search_btn_border">
		...
		<xsl:if test="search_button_border_radius!='0'">border-radius: <xsl:value-of select="search_button_border_radius"/>px;</xsl:if>
	</xsl:variable>
	...
	<xsl:variable name="_css_gloss_border_radius">
		<xsl:if test="number(gloss_border_radius)!=0">border-radius: <xsl:value-of select="gloss_border_radius"/>px;</xsl:if>
	</xsl:variable>
	<xsl:variable name="_css_gloss_letter_border_radius">
		<xsl:if test="number(gloss_border_radius)!=0">border-radius: <xsl:value-of select="round(0.5*number(gloss_border_radius))"/>px;</xsl:if>
	</xsl:variable>
	...
	<xsl:variable name="_css_gloss_idle">
		<xsl:choose>
			...
			<xsl:when test="gloss_fill_type='image'">
				background-image: url('file:///<xsl:value-of select="translate(substring-before($moduleImagesFolder,'images\'),'\','/')"/><xsl:value-of select="gloss_img_idle"/>'); <xsl:value-of select="$gloss_bgimg_position_css"/> background-repeat: <xsl:value-of select="gloss_img_repeat"/>;
			</xsl:when>
		</xsl:choose>
	...
	<xsl:variable name="_css_gloss_selected">
		<xsl:choose>
			...
			<xsl:when test="gloss_fill_type='image'">
				background-image: url('file:///<xsl:value-of select="translate(substring-before($moduleImagesFolder,'images\'),'\','/')"/><xsl:value-of select="gloss_img_selected"/>'); <xsl:value-of select="$gloss_bgimg_position_css"/> background-repeat: <xsl:value-of select="gloss_img_repeat"/>;
			</xsl:when>
		</xsl:choose>
	...
	<style>
		...
		.cl-body-header { padding: 0 0 <xsl:value-of select="panel_padding"/>px 0; }
		.cl-tab-container { <xsl:value-of select="$_css_tab_container_position"/><xsl:value-of select="$_css_tab_container_sizes"/> }
		.cl-tab { <xsl:value-of select="$_css_tab_position"/> <xsl:value-of select="$_css_tab_sizes"/> }
		.cl-tab-html { border-color: <xsl:value-of select="$tab_brd_color"/>; <xsl:value-of select="$_css_tab_html_sizes"/><xsl:value-of select="$_css_tab_html_border_width"/><xsl:value-of select="$_css_tab_html_border_radius"/><xsl:value-of select="$tab_bg_css"/> }
		.cl-tab-html-text { <xsl:value-of select="$_css_tab_html_text_pos_size"/><xsl:value-of select="$_css_tab_html_text_transform"/> }
		.cl-tab-html-text-table { <xsl:value-of select="$_css_tab_html_table_size"/> }
		.cl-tab-html-text-table-td { color: <xsl:value-of select="$tab_txt_color"/>; <xsl:value-of select="$_css_tab_html_table_size"/><xsl:value-of select="$tab_font_css"/> }
		.cl-tab-img { <xsl:value-of select="$_css_tab_sizes"/><xsl:value-of select="$_css_tab_img_position"/> }
		.cl-tab-img img { <xsl:value-of select="$_css_tab_img_position"/> }

		.cl-slide-list li { padding: <xsl:value-of select="item_padding"/>px <xsl:value-of select="item_padding"/>px <xsl:value-of select="item_padding"/>px 0; <xsl:value-of select="$_css_contents_font"/> }
		.cl-slide-list .cl-item-inner { padding: 2px 0 0 20px; min-height: 16px; }
		...
		.visited .cl-item-inner { <xsl:value-of select="$_css_contents_visited_bg"/> }
		.current .cl-item-inner { <xsl:value-of select="$_css_contents_current_bg"/> }
		.unvisited .cl-item-inner { <xsl:value-of select="$_css_contents_unvisited_bg"/> }
		...
		.cl-sett-table { width: 100%; border-spacing: 0; }
		...
		.cl-sett-table .cl-sett-th { text-align: left; white-space: nowrap; <xsl:value-of select="$_css_sett_border_top"/><xsl:value-of select="$_css_sett_border_bottom"/> }
		.cl-sett-table .cl-set-value { text-align: center; <xsl:value-of select="$_css_sett_border_bottom"/> }
		.cl-sett-table .cl-sett-name { text-align: left; width: 100%; <xsl:value-of select="$_css_sett_border_bottom"/> }
		.cl-sett-score { background-color: #eee; }
	...
	<div>
		<xsl:attribute name="class">clo-nav_0002_navi_tab</xsl:attribute>
		<div>
			...
			<xsl:choose>
				<xsl:when test="tab_type='image'">
					<div>
						<xsl:attribute name="class">cl-tab-container</xsl:attribute>
						<div>
							<xsl:attribute name="class">cl-tab unselectable</xsl:attribute>
							<div>
	...
	<script>function Adjust()
	{
		...
		if(sRole=="glossary")
		{
			if(document.getElementsByClassName("cl-letters-box").length!=0)
			{
				...
				{
					sLetter = aLetters[iCnt].getAttribute("data-letter");
					sLetterUp = sLetter.toUpperCase();
					if(sLetter!=sLetterUp)
					{
						aFoundUp = document.querySelectorAll(".cl-letter-item[data-letter='" + sLetterUp + "']");
						if(aFoundUp.length==0)
						{
							aLetters[iCnt].innerHTML = sLetterUp;
						}
						else
						{
							aIdxToRemove.push(iCnt);
						}
					}
					iCnt--;
				}
				iCnt = 0;
				while(aIdxToRemove[iCnt]!=null)
				{
					aLetters[aIdxToRemove[iCnt]].parentNode.parentNode.removeChild(aLetters[aIdxToRemove[iCnt]].parentNode);
					iCnt++;
				}
				aLetters = document.getElementsByClassName("cl-letter-item");
				var iW;
				iCnt = 0;
				while(aLetters[iCnt]!=null)
				{
